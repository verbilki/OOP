...
Этот проект представляет собой Домашнее задание по уроку 16.1 (блок '4. Объектно-ориентированное программирование')
...
2. Для сущности Product реализован следующий функционал:
   ...
   - цвет (color).
4. для сущности Category реализован следующий функционал:
   ...
   - getter products_list для приватного атрибута __products (список продуктов).

### Запуск приложения

Для запуска приложения необходимо запустить на исполнение модуль src/main.py.

### Настройка и использование фреймворка unit-тестирования Pytest

Исходный код модулей покрыт юнит-тестами Pytest на 85+%. Для запуска выполните команды:
